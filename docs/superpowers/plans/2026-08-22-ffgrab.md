...
- Radio de esquinas entre **9px y 16px**. Por encima el relieve neumórfico se deshace en las esquinas.
- El color de acento (`--accent`) se usa **solo** en la acción principal y en las barras de progreso. En ningún otro elemento.
